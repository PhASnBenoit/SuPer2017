...
//    QTimer *tpsSens[MAXLECTEURS];   //timer sur la réception
    QTimer *tpsSens;   //timer sur la réception
    /*-----Badge-----*/
    int numBadge;           //numéro de badge
    QString id_badge[MAXBADGES];    //identifiant du badge
    ...
    QTimer *tpsLecteurs[MAXLECTEURS]; // timer des lecteurs pour la détermination des zones  12/11/2017
    ...
    QString email[MAXPERSONNES];    //email
    QString portable[MAXPERSONNES]; //portable
